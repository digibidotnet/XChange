...
public interface AccountService extends BaseService {
  ...
  /**
   * Gets the trading fee for a specific currency pair as determined by the given exchange's rules for
   * adjusting fees by recent volume traded.
   * 
   * @param currencyPair The currency pair to request trade fees for
   ...
   * @throws IOException - Indication that a networking error occurred while fetching JSON data
   */
  default Fee getDynamicTradingFeeForPair(CurrencyPair currencyPair) throws IOException {
    throw new NotYetImplementedForExchangeException("getDynamicTradingFees");
  }
}
